...
export class Migration20250710174530 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql('create table "refresh_token" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "user_id" uuid not null, "token" text not null, "expires_at" timestamptz not null, constraint "refresh_token_pkey" primary key ("id"));');
