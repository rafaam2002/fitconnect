...
export class Migration20260322164422 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "user_role" alter column "role" set default 'standard';`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "user" add column "is_admin_verified" bool not null default false;`);
