...
export class Migration20260501131350_add_apple_id_to_user extends Migration {
  override async up(): Promise<void> {
    this.addSql(`alter table "user" add column "apple_id" varchar(255) null;`);
    this.addSql(`create index "user_apple_id_index" on "user" ("apple_id");`);
    this.addSql(
      `alter table "user" add constraint "user_apple_id_unique" unique ("apple_id");`
    );
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`drop index "user_apple_id_index";`);
    this.addSql(`alter table "user" drop constraint "user_apple_id_unique";`);
  }
}
