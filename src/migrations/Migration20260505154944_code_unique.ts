...
export class Migration20260505154944_code_unique extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `alter table "company" alter column "code" type varchar(255) using ("code"::varchar(255));`
    );
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "company" drop constraint "company_code_unique";`);
