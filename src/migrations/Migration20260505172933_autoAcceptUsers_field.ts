...
export class Migration20260505172933_autoAcceptUsers_field extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `alter table "company_config" add column "auto_accept_users" boolean not null default true;`
    );
  }
