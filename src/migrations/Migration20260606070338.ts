...
export class Migration20260606070338 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `alter table "user_weight" alter column "weight" type real using ("weight"::real);`
    );
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(
      `alter table "user_weight" alter column "weight" type int4 using ("weight"::int4);`
    );
  }
}
