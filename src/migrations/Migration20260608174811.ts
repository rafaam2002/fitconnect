...
export class Migration20260608174811 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `alter table "schedule_options" add column "quota_warning_thresholds" jsonb not null default '[]';`
    );

    this.addSql(
      `alter table "schedule" add column "notified_quota_thresholds" jsonb not null default '[]';`
    );
  }
