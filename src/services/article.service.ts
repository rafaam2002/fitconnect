...
import {
    ...
    GatewayTimeoutError,
    handleExternalAPIError, createServiceResponse
...
export class ArticleService extends BaseService {
    ...
    constructor(em: EntityManager) {
        ...
        this.apiBaseUrl = process.env.ARTICLES_API_URL || 'https://api.example.com/articles';
    ...
    async getArticles(input: GetArticlesInput): Promise<ServiceResponse> {
        ...
        try {
            ...
            return createServiceResponse(200, 'Articles fetched successfully', true, articles)
        } catch (error: any) {
     ...
     */
    private async parseJSONResponse(response: Response): Promise<ExternalAPIResponse> {
        try {
