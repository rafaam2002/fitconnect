...
export class CompanyService extends BaseService {
    ...
    public async getCompanies(
        ...
        if (companyId) {
            ...
            const [companies, totalItems] = await this.em.findAndCount(Company, where, {
                limit,
                offset,
                populate: ['scheduleOptions'],
                filters: false,
            ...
            return createServiceResponse(200, 'Companies fetched successfully', true, {
    ...
    public async createCompany(
        ...
        await this.emailService.sendCompanyVerificationEmail(companyToken, companyData, user);
