...
import {BadRequestError, ConflictError, createServiceResponse, NotFoundError} from '../utils/errors.util';
...
export class PaymentMethodService extends BaseService {
     ...
     */
    public async getPaymentMethod(paymentMethodId: string): Promise<ServiceResponse> {
        ...
        return createServiceResponse(200, 'Payment method is fetched successfully', true, {
            paymentMethod
        });
    }
     ...
     */
    public async listPaymentMethods(stripeCustomerId: string): Promise<ServiceResponse> {
        ...
        return createServiceResponse(200, 'Payment methods are fetched successfully', true, {
            paymentMethods,
     ...
     */
    public async listUserPaymentMethods(userId: string): Promise<ServiceResponse> {
     ...
     */
    public async getDefaultPaymentMethod(stripeCustomerId: string): Promise<ServiceResponse> {
        ...
        return createServiceResponse(200, 'Default payment method is fetched successfully', true, {
            paymentMethod
        });
     ...
     */
    public async getUserDefaultPaymentMethod(userId: string): Promise<ServiceResponse> {
        ...
        if (!stripeCustomer) {
            return createServiceResponse(200, 'No default payment method found', true, {
                paymentMethod: null
            });
        }
        ...
        return createServiceResponse(200, 'Default user payment method is fetched successfully', true, {
     ...
     */
    public async getExpiredPaymentMethods(stripeCustomerId: string): Promise<ServiceResponse> {
        const stripeCustomer = await this.em.findOne(StripeCustomer, {
            stripeCustomerId,
            isActive: true
        });
        ...
        return createServiceResponse(200, 'Expired payment methods are fetched successfully', true, {
            paymentMethods
        });
    }
     ...
     */
    public async getPaymentMethodsStats(stripeCustomerId: string): Promise<ServiceResponse> {
        const stripeCustomer = await this.em.findOne(StripeCustomer, {
            stripeCustomerId,
            isActive: true
        });
        ...
        return createServiceResponse(200, 'Payment method stats are fetched successfully', true, {
            stats
        });
    }
     ...
     * Crear Setup Intent
     */
    public async createSetupIntent(input: CreateSetupIntentInput): Promise<ServiceResponse> {
        const stripeCustomer = await this.em.findOne(StripeCustomer, {
        ...
        return createServiceResponse(200, 'Setup Intent created successfully', true, {
     ...
     */
    public async confirmSetupIntent(input: ConfirmSetupIntentInput): Promise<ServiceResponse> {
        const setupIntent = await this.stripe.setupIntents.retrieve(input.setupIntentId);

        if (setupIntent.status !== 'succeeded') {
            throw new BadRequestError(`Setup Intent not successful. Status: ${setupIntent.status}`);
        }
        ...
        if (stripePaymentMethod.card?.fingerprint) {
            ...
            if (existingPaymentMethod) {
                ...
                return createServiceResponse(200, 'Payment method confirmed and attached successfully', true, {
     ...
     */
    public async attachPaymentMethod(input: AttachPaymentMethodInput): Promise<ServiceResponse> {
        const stripeCustomer = await this.em.findOne(StripeCustomer, {
            stripeCustomerId: input.stripeCustomerId,
            isActive: true
        });
        ...
        if (existingPaymentMethod) {
            throw new ConflictError('Payment method already attached to this customer');
        }
        ...
        if (stripePaymentMethod.card?.fingerprint) {
            ...
            if (duplicatePaymentMethod) {
                throw new ConflictError('A payment method with the same card already exists');
            }
        }
        ...
        return createServiceResponse(200, 'Payment method attached successfully', true, {
            paymentMethod
        });
    }
     ...
     */
    public async removePaymentMethod(paymentMethodId: string): Promise<ServiceResponse> {
        const paymentMethod = await this.em.findOne(PaymentMethod, {
            stripePaymentMethodId: paymentMethodId,
            status: PaymentMethodStatus.ACTIVE
        });
        ...
        return createServiceResponse(200, 'Payment method removed successfully', true);
    }

    /**
     * Establecer payment method como default
     */
    public async setDefaultPaymentMethod(paymentMethodId: string): Promise<ServiceResponse> {
        const paymentMethod = await this.em.findOne(PaymentMethod, {
            stripePaymentMethodId: paymentMethodId,
            status: PaymentMethodStatus.ACTIVE
        }, {
        ...
        return createServiceResponse(200, 'Default payment method updated successfully', true, {
            paymentMethod
        });
    }
    ...
    public async updatePaymentMethodMetadata(
        ...
        return createServiceResponse(200, 'Payment method updated successfully', true, {
            paymentMethod
        });
    }
     ...
     */
    public async markPaymentMethodAsExpired(paymentMethodId: string): Promise<ServiceResponse> {
        const paymentMethod = await this.em.findOne(PaymentMethod, {
            stripePaymentMethodId: paymentMethodId
        });
        ...
        return createServiceResponse(200, 'Payment method marked as expired successfully', true, {
            paymentMethod
        });
    }
     ...
     */
    public async cleanupExpiredPaymentMethods(stripeCustomerId: string): Promise<ServiceResponse> {
        const stripeCustomer = await this.em.findOne(StripeCustomer, {
            stripeCustomerId,
            isActive: true
        });
     ...
     */
    public async syncPaymentMethodFromStripe(paymentMethodId: string): Promise<ServiceResponse> {
        const stripePaymentMethod = await this.stripe.paymentMethods.retrieve(paymentMethodId);

        if (!stripePaymentMethod.customer) {
            throw new BadRequestError('Payment method not found in Stripe or not attached to customer');
        }
        ...
        return createServiceResponse(200, 'Payment method synchronized successfully', true, {
            paymentMethod
        });
    }
     ...
     */
    public async validatePaymentMethod(paymentMethodId: string): Promise<ServiceResponse> {
        const paymentMethod = await this.em.findOne(PaymentMethod, {
            stripePaymentMethodId: paymentMethodId
        });

        if (!paymentMethod) {
            return createServiceResponse(400, 'Payment method validation failed: Payment method not found', false, {
                isValid: false,
