...
const bucketName = process.env.AWS_BUCKET_NAME || "pre-signed-url-demo-gondorwebmasters";
...
export class S3Service extends BaseService {
    ...
    public async getPresignedUrl(
        ...
        try {
            ...
            return createServiceResponse(200, 'Presigned URL generated successfully', true, {
                presignedUrl: url,
                key: Key,
            });
        } catch (error: any) {
