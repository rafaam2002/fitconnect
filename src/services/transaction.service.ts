...
export class TransactionService extends BaseService {
     ...
     */
    public async createCharge(input: CreateChargeInput): Promise<ServiceResponse> {
     ...
     */
    public async refundTransaction(input: RefundTransactionInput): Promise<ServiceResponse> {
        ...
        if (!originalTransaction) {
            throw new NotFoundError('Original transaction not found or not eligible for refund');
        }

        if (!originalTransaction.stripeChargeId) {
            throw new BadRequestError('No Stripe charge ID found for this transaction');
        }
        ...
        try {
            ...
            return createServiceResponse(200, 'Transaction refunded successfully', true, {
    ...
    public async getTransaction(transactionId: string): Promise<ServiceResponse> {
        ...
        return createServiceResponse(200, 'Transaction fetched successfully', true, {
            transaction,
        });
    }
    ...
    public async listUserTransactions(
        ...
        try {
            ...
            return createServiceResponse(200, 'Transactions listed successfully', true, {
                transactions,
            });
        } catch (error: any) {
            if (error instanceof NotFoundError || error instanceof BadRequestError) {
    ...
    public async getSuccessfulTransactions(
        ...
        return await this.getTransactionsByStatus(userId, TransactionStatus.SUCCEEDED, limit);
    }
    ...
    public async getFailedTransactions(
        ...
        return await this.getTransactionsByStatus(userId, TransactionStatus.FAILED, limit);
    }

    /**
     * Obtener resumen de transacciones de usuario
     */
    public async getUserTransactionsSummary(userId: string): Promise<ServiceResponse> {
        try {
            ...
            return createServiceResponse(200, 'Summary loaded successfully', true, {summary});
        } catch (error: any) {
     ...
     */
    public async retryFailedTransaction(transactionId: string): Promise<ServiceResponse> {
        ...
        try {
            ...
            return createServiceResponse(200, 'Transaction retry initiated successfully', true, {
    ...
    public async markTransactionAsReconciled(
        ...
        try {
            ...
            return createServiceResponse(200, 'Transaction reconciled successfully', true, {
                transaction,
            });
        } catch (error: any) {
     ...
     */
    public async syncTransactionFromStripe(stripeChargeId: string): Promise<ServiceResponse> {
        ...
        try {
            ...
            if (!transaction) {
                ...
                transaction.failureReason = stripeCharge.failure_message ?? 'Failed transaction';
            ...
            return createServiceResponse(200, 'Transaction synchronized successfully', true, {
                transaction,
            });
        } catch (error: any) {
            if (error instanceof NotFoundError) {
